...
router.post('/subscribe', subscribeValidation, controller.subscribeNewsletter);

// Unsubscribe from newsletter (no authentication required)
router.post('/unsubscribe', unsubscribeValidation, controller.unsubscribeNewsletter);
